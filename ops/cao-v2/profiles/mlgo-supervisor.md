---
name: mlgo-supervisor
description: MLGO Codex Business authoritative supervisor; medium effort and semantic-only v2 authority.
provider: codex
role: supervisor
codexExecutable: mlgo-codex-business
model: gpt-5.6-sol
codexConfig:
