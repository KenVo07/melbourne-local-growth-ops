---
name: mlgo-codex-business-2-supervisor
description: Explicit-operator-only Codex Business 2 authoritative supervisor; never an automatic worker or replacement.
provider: codex
role: supervisor
