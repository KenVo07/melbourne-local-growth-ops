---
name: mlgo-codex-plus-supervisor
description: MLGO Codex Plus authoritative supervisor; medium effort and semantic-only v2 authority.
provider: codex
role: supervisor
codexExecutable: mlgo-codex-plus
model: gpt-5.6-sol
codexConfig:
